...
# Kalıcı hale getirmek için .bashrc ve .zshrc içine sadece eksikse ekle
...
echo "ℹ️  Artık tüm komutlar Türkçeleştirildi, terminali kapatıp açın ya da 'source ~/.bashrc' veya 'source ~/.zshrc' komutlarıyla yükleyin."
